    ...
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {customer && (
          <button
            type="button"
            onClick={() => navigate(`/service/new?customerId=${customer.id}`)}
            className="rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/5"
          >
            New service order
          </button>
        )}
